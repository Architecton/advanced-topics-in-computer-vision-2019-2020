...
from ex2_utils import create_epanechnik_kernel, get_patch, extract_histogram, backproject_histogram
...
class MSParams():
    ...
    def __init__(self, max_it=20, n_bins=22, alpha=0.006):
        self.max_it = max_it
        self.n_bins = n_bins
        self.alpha = alpha
...
class MeanShiftTracker(Tracker):
    ...
    Args:
        parameters (obj): MSParams instance specifying the parameters for the tracker.
    """

    def __init__(self, parameters=MSParams()):
