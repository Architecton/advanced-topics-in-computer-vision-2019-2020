...
U_hs, V_hs = horn_schunck(im1, im2, n_iters=250, lmbd=0.5, derivative_smoothing=True)
 
# Horn-Schunck with Lucas-Kanade initialization results.
U_hs_init, V_hs_init = horn_schunck(im1, im2, n_iters=250, lmbd=0.5, derivative_smoothing=True, u_init=U_lk+0.0, v_init=V_lk+0.0)
